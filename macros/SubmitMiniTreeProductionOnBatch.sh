...
base=`echo "TotoAna_miniTree.C" | cut -d . -f -1`;
cp ${base}.C ${base}_DATA_27.C;
sed -i -e "/DATA/s/false/true/g" ${base}_DATA_27.C;
sed -i -e "s/for(unsigned int ievt=0; ievt<nTotEvents; ievt++)/for(unsigned int ievt=60750000; ievt<61424841; ievt++)/g" ${base}_DATA_27.C;
sed -i -e "s/miniTree_DATA.root/miniTree_DATA__27.root/g" ${base}_DATA_27.C;
g++ ${base}_DATA_27.C `root-config --libs --cflags` -m32 -O3 -o ${base}_DATA_27;
cp batch_template.sh batch_DATA_27.sh;
sed -i -e "s/TEMPLATE/DATA_27/g" batch_DATA_27.sh; qsub batch_DATA_27.sh;
...
sed -i -e "/MC_MinBias_TuneD6T_7TeV-pythia6_Spring10-START3X_V26B-v1/s/false/true/g" ${base}_MC_MinBias_TuneD6T_7TeV-pythia6_Spring10-START3X_V26B-v1_3.C
...
sed -i -e "/MC_MinBias_TuneP0_7TeV-pythia6_Spring10-START3X_V26B-v1/s/false/true/g" ${base}_MC_MinBias_TuneP0_7TeV-pythia6_Spring10-START3X_V26B-v1_3.C;
...
sed -i -e "/MC_MinBias_7TeV-pythia8_Spring10-START3X_V26B-v1/s/false/true/g" ${base}_MC_MinBias_7TeV-pythia8_Spring10-START3X_V26B-v1_3.C;
...
sed -i -e "/MC_QCD_Pt-15_7TeV-pythia6_Spring10-START3X_V26B-v1/s/false/true/g" ${base}_MC_QCD_Pt-15_7TeV-pythia6_Spring10-START3X_V26B-v1_2.C;
