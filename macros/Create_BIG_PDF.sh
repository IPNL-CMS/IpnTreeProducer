...
\includegraphics[width=.36\textwidth]{pdf/DataMC_SuperClu_Multiplicity_isAfterCut7_NoCuts.pdf}
\\
\footnotesize
...
\includegraphics[width=.36\textwidth]{pdf/DataMC_SuperClu_Multiplicity_isAfterCut7_NoCuts_log.pdf}
\\
\end{center}
\end{frame}" >> presentation_${directory}.tex


for cut in `echo "isAfterCut7 isAfterCut7_RawEtGT2 isAfterCut7_RawEtGT4 isAfterCut7_RawEtGT10"`
do
...
\end{frame}
" >> presentation_${directory}.tex
	for variable in `echo "E Et RawE RawEt Eta Phi etaWidth phiWidth nXtals brem Eseed_o_Esc E2x2_o_E5x5 S2_o_Esc"`
	do
		Variable=`echo "${variable}" | sed -e 's/_/ /g'`
		echo "
...
\includegraphics[width=.36\textwidth]{pdf/DataMC_Photon_Multiplicity_isAfterCut10_NoCuts.pdf}
\\
\hspace{.36\textwidth}before selection\hspace{.36\textwidth}after selection
\\
\includegraphics[width=.36\textwidth]{pdf/DataMC_Photon_Multiplicity_NoCuts_log.pdf}
\includegraphics[width=.36\textwidth]{pdf/DataMC_Photon_Multiplicity_isAfterCut10_NoCuts_log.pdf}
\end{center}
\end{frame}
