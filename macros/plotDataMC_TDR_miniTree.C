...
//      Plots for super-clusters
        ...
        set_of_cuts_superclu.push_back("SuperClu_isEE==1");
        name_superclu.push_back("SuperClu_isEE");
        set_of_cuts_superclu.push_back("SuperClu_isEB==1");
        name_superclu.push_back("SuperClu_isEB");
        set_of_cuts_superclu.push_back("SuperClu_isEEP==1");
        name_superclu.push_back("SuperClu_isEEP");
        set_of_cuts_superclu.push_back("SuperClu_isEEM==1");
        name_superclu.push_back("SuperClu_isEEM");

	for (i=0;i<name_superclu.size();i++){
	  DrawDataMCplot_NormEntries_Fast(Data_SuperCluTree, MC_SuperCluTree, "SuperClu_E", "(100, 0, 800)", set_of_cuts_superclu[i], name_superclu[i], "SuperCluster Energy", true, false, c1);
          ...
          DrawDataMCplot_NormEntries_Fast(Data_SuperCluTree, MC_SuperCluTree, "SuperClu_nXtals", "(3, 0, 3)", set_of_cuts_superclu[i], name_superclu[i], "SuperCluster number of crystals", true, false, c1);
	...
	set_of_cuts_events.pushback("NoCuts");
	name_events.pushback("NoCuts");
	for(i=0;i<name_events.size();i++){
	...
	DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "SuperClu_Multiplicity", "(15, 0, 15)", set_of_cuts_events[i], name_events[i], "Super cluster multiplicity", true, false, c1);

	DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "nPhotonEB_perEvent", "(3, 0, 3)", set_of_cuts_events[i], name_events[i],"nPhotonEB_perEvent", true, false, c1);
	DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "nPhotonEE_perEvent", "(3, 0, 3)", set_of_cuts_events[i], name_events[i],"nPhotonEE_perEvent", true, false, c1);
	DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "nPhotonEEP_perEvent", "(3, 0, 3)", set_of_cuts_events[i], name_events[i],"nPhotonEEP_perEvent", true, false, c1);
	DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "nPhotonEEM_perEvent", "(3, 0, 3)", set_of_cuts_events[i], name_events[i], "nPhotonEEM_perEvent", true, false, c1);
