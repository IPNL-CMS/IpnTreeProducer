...
//	cout<<"\tDEBUG:\tEntering main()"<<endl;
  ...
  TTree* Data_eventTree = (TTree*) Data_File->Get("miniTree");
	...
	vector<string> name;
	set_of_cuts.push_back("Photon_isAfterCut6==1");
	name.push_back("Photon_isAfterCut6");
	set_of_cuts.push_back("Photon_isAfterCut6==1 && Photon_isEB==1");
	name.push_back("Photon_isAfterCut6_AND_Photon_isEB");
	set_of_cuts.push_back("Photon_isAfterCut6==1 && Photon_isEE==1");
	name.push_back("Photon_isAfterCut6_AND_Photon_isEE");
	set_of_cuts.push_back("Photon_isAfterCut6==1 && Photon_isEEP==1");
	name.push_back("Photon_isAfterCut6_AND_Photon_isEEP");
	set_of_cuts.push_back("Photon_isAfterCut6==1 && Photon_isEEM==1");
	name.push_back("Photon_isAfterCut6_AND_Photon_isEEM");
	set_of_cuts.push_back("Photon_SCRawEnergy>4 && Photon_isAfterCut6==1 && Photon_isEEM==1");
	...
	for(int i=0; i<set_of_cuts.size() ; i++){ // loop over different set of cuts
	  ...
	  DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "Photon_Phi", "(30, -3.15, 3.15)", set_of_cuts[i], name[i], "Photon Phi", true, false, c1);
	  ...
	  DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "Photon_SCPhi", "(30, -3.15, 3.15)", set_of_cuts[i], name[i], "Photon SC Phi", true, false, c1);
	  ...
	  DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "Photon_cross", "(50, -4, 2)", set_of_cuts[i], name[i], "Photon 1-(E4/E1)", true, false, c1);
	  ...
	  DrawDataMCplot_NormEntries_Fast(Data_eventTree, MC_eventTree, "Photon_convNTracks", "(5, -1, 4)", set_of_cuts[i], name[i], "Photon convNTracks", true, false, c1);
