...
# RECO
   fileNames = cms.untracked.vstring(
    'file:/afs/cern.ch/user/r/rchieric/scratch0/CMSSW_3_5_6/src/UserCode/IpnTreeProducer/test/testPATLyon.root'
...
process.totoana = cms.EDAnalyzer("TotoAnalyzer",
	myConfig = cms.PSet(
		...
		xsection = cms.untracked.double(165),
		description = cms.untracked.string('TTbar'),
...
#		signalGenerator = cms.untracked.string('ALPGEN'),
		...
		keepClusterizedEcalRecHits = cms.untracked.bool(False),
		keepAllEcalRecHits = cms.untracked.bool(False),
		doMET = cms.untracked.bool(True),
		doBardak = cms.untracked.bool(False),
		...
		conversionLikelihoodWeightsFile = cms.untracked.string('RecoEgamma/EgammaTools/data/TMVTotoana_Likelihood.weights.txt'),
...
#process.p = cms.Path(process.photonIDSequence*process.totoana)
...
#process.p = cms.Path(process.hltHighLevel*process.countPatMuons*process.countPatJets*process.totoana)
